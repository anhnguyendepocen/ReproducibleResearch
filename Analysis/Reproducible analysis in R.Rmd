...
The table below shows local authorities with more than 10% of their area not covered by 2G network.

```{r, echo=TRUE}
kable(coverage_data[coverage_data$M2G.NoS>10, c("LocalAuthority", "M2G.NoS")])
```
